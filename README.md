...
## Latest Release
* v1.8
  * v1.8.2 - Read the full release [notes](https://github.com/rancher/rke/releases/tag/v1.8.2).
* v1.7
  * v1.7.6 - Read the full release [notes](https://github.com/rancher/rke/releases/tag/v1.7.6).
* v1.6
