...
## Latest Release
* v1.4
  * v1.4.0 - Read the full release [notes](https://github.com/rancher/rke/releases/tag/v1.4.0).
* v1.3
  * v1.3.16 - Read the full release [notes](https://github.com/rancher/rke/releases/tag/v1.3.16).
* v1.2
